...
def custom_score(game, player):
    ...
    mymoves = len(move(game.get_legal_moves()))
    opponentsmoves = len(game.get_legal_moves((game.get_opponent(player))))

    # i = 1
    return (len(game.get_blank_spaces())) / (game.height * game.width)
...
"""
    ...
    return my_moves - (i * opponents_moves)
"""
